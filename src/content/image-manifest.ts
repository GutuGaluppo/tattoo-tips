...
export const imageManifest = {
  ...
  'product-bishop-power-wand': { width: 1024, height: 1024, aspectRatio: 1, sizes: [480, 960] },
  'product-cheyenne-sol-nova': { width: 1000, height: 1000, aspectRatio: 1, sizes: [480, 960] },
  'product-critical-torque': { width: 1000, height: 1000, aspectRatio: 1, sizes: [480, 960] },
  'product-dermalize-pro-film': { width: 800, height: 800, aspectRatio: 1, sizes: [480] },
  'product-dynamic-union-black': { width: 1946, height: 1946, aspectRatio: 1, sizes: [480, 960, 1600] },
  'product-electrum-stencil-primer': { width: 1500, height: 1500, aspectRatio: 1, sizes: [480, 960] },
  'product-fk-irons-flux-max': { width: 1000, height: 1000, aspectRatio: 1, sizes: [480, 960] },
  'product-hustle-butter-deluxe': { width: 1000, height: 1000, aspectRatio: 1, sizes: [480, 960] },
  'product-kwadron-cartridge-system': { width: 550, height: 460, aspectRatio: 1.1957, sizes: [480] },
  'product-panthera-black-gold': { width: 1426, height: 1426, aspectRatio: 1, sizes: [480, 960] },
  'product-spirit-classic-thermal': { width: 1445, height: 1445, aspectRatio: 1, sizes: [480, 960] },
  'product-stencil-stuff': { width: 300, height: 315, aspectRatio: 0.9524, sizes: [300] },
  'product-unigloves-black-pearl': { width: 1600, height: 1200, aspectRatio: 1.3333, sizes: [480, 960, 1600] },
