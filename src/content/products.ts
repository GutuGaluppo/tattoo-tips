...
export const products: Product[] = [
  ...
  },
  {
    ...
    tier: 'pro',
    editorialNote:
      'Filme de segunda pele registrado como dispositivo médico classe I na Itália e nos EUA (FDA). Discussão de fórum relata boa aceitação geral, com uma taxa de reação ao adesivo estimada em torno de 10% dos casos.',
    forumSources: [
      {
  ...
  },
  {
    ...
    brand: 'Unigloves',
    priceApprox: '~€10–35 / 100 un., varia muito por fornecedor',
    priceCheckedAt: '2026-09-05',
  ...
  },
  {
    ...
    euReach: true,
    editorialNote:
      'Preto all-round citado com frequência como referência para lining e sombreado. Em discussão de fórum, artistas relatam que se manteve o mais escuro depois de cicatrizado entre várias marcas testadas lado a lado.',
    forumSources: [
      {
  ...
  },
  {
    ...
    brand: 'Magic Moon',
    priceApprox: '~€15–40, conforme linha e embalagem',
    priceCheckedAt: '2026-09-05',
